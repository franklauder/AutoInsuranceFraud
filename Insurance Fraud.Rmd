...
print(classification_report(y_test_rv, y_pred_test_svc))
...
svc_recall_test=recall_score(y_test_rv, y_pred_test_svc).round(2)
...
svc_precision_test=precision_score(y_test_rv, y_pred_test_svc).round(2)
...
svc_f1_test=f1_score(y_test_rv, y_pred_test_svc).round(2)
...
rf_recall_test=recall_score(y_test_rv, y_pred_test_rf).round(2)
...
rf_precision_test=precision_score(y_test_rv, y_pred_test_rf).round(2)
...
rf_f1_test=f1_score(y_test_rv, y_pred_test_rf).round(2)
...
print(classification_report(y_test_rv, y_pred_test_rf))
...
y_pred_test_adb=adb_clf.predict(X_test_tr)
...
print(classification_report(y_test_rv, y_pred_test_adb))
...
adb_recall_test=recall_score(y_test_rv, y_pred_test_adb).round(2)
...
adb_precision_test=precision_score(y_test_rv, y_pred_test_adb).round(2)
...
adb_f1_test=f1_score(y_test_rv, y_pred_test_adb).round(2)
...
y_pred_test_gb=gb_clf.predict(X_test_tr)
...
print('******Gradient Boost Test Set Classification Report******')


print(classification_report(y_test_rv, y_pred_test_gb))
...
gb_recall_test=recall_score(y_test_rv, y_pred_test_gb).round(2)
...
gb_precision_test=precision_score(y_test_rv, y_pred_test_gb).round(2)
...
pickle_in=open("gb_precision_test","rb")
gb_precision_test=pickle.load(pickle_in)
...
gb_f1_test=f1_score(y_test_rv, y_pred_test_gb).round(2)
...
y_pred_test_xg=xg_clf.predict(X_test_tr)
...
file_out=open("y_pred_test_xg","wb")
pickle.dump(y_pred_test_xg, file_out)
file_out.close()
...
pickle_in=open("y_pred_test_xg","rb")
y_pred_test_xg=pickle.load(pickle_in)
...
print('******Extreme Gradient Boost Test Set Classification Report******')

print(classification_report(y_test_rv, y_pred_test_xg))
...
xg_recall_test=recall_score(y_test_rv, y_pred_test_xg).round(2)
...
file_out=open("xg_recall_test","wb")
pickle.dump(xg_recall_test, file_out)
file_out.close()
...
pickle_in=open("xg_recall_test","rb")
xg_recall_test=pickle.load(pickle_in)
...
xg_precision_test=precision_score(y_test_rv, y_pred_test_xg).round(2)
...
file_out=open("xg_precision_test","wb")
pickle.dump(xg_precision_test, file_out)
file_out.close()
...
pickle_in=open("xg_precision_test","rb")
xg_precision_test=pickle.load(pickle_in)
...
xg_f1_test=f1_score(y_test_rv, y_pred_test_xg).round(2)
...
file_out=open("xg_f1_test","wb")
pickle.dump(xg_f1_test, file_out)
file_out.close()
...
pickle_in=open("xg_f1_test","rb")
xg_f1_test=pickle.load(pickle_in)
...
y_pred_test_lgb=lgb_clf.predict(X_test_tr)
...
file_out=open("y_pred_test_lgb","wb")
pickle.dump(y_pred_test_lgb, file_out)
file_out.close()
...
pickle_in=open("y_pred_test_lgb","rb")
y_pred_test_lgb=pickle.load(pickle_in)
...
print('******Light Gradient Boost Test Set Classification Report******')

print(classification_report(y_test_rv, y_pred_test_lgb))
...
lgb_recall_test=recall_score(y_test_rv, y_pred_test_lgb).round(2)
...
file_out=open("lgb_recall_test","wb")
pickle.dump(lgb_recall_test, file_out)
file_out.close()
...
pickle_in=open("lgb_recall_test","rb")
lgb_recall_test=pickle.load(pickle_in)
...
lgb_precision_test=precision_score(y_test_rv, y_pred_test_lgb).round(2)
...
file_out=open("lgb_precision_test","wb")
pickle.dump(lgb_precision_test, file_out)
file_out.close()
...
pickle_in=open("lgb_precision_test","rb")
lgb_precision_test=pickle.load(pickle_in)
...
lgb_f1_test=f1_score(y_test_rv, y_pred_test_lgb).round(2)
...
file_out=open("lgb_f1_test","wb")
pickle.dump(lgb_f1_test, file_out)
file_out.close()
...
pickle_in=open('lgb_f1_test',"rb")
lgb_f1_test=pickle.load(pickle_in)
...
test_val_scores=pd.DataFrame({'Model':['Support Vector Machine', 'Random Forest','Ada Boost', 'Gradient Boosting', 'Extreme Gradient Boosting', 'Light GBM'],
'Recall Validation':[svc_recall, rf_recall,adb_recall, gb_recall, xg_recall, lgb_recall],
'Recall Test':[svc_recall_test, rf_recall_test,adb_recall_test, gb_recall_test, xg_recall_test, lgb_recall_test],
'Precision Validation':[svc_precision, rf_precision,adb_precision, gb_precision, xg_precision, lgb_precision],
'Precision Test':[svc_precision_test, rf_precision_test,adb_precision_test, gb_precision_test, xg_precision_test, lgb_precision_test],
'F1 Validation':[svc_f1, rf_f1,adb_f1, gb_f1, xg_f1, lgb_f1],
'F1 Test':[svc_f1_test, rf_f1_test,adb_f1_test, gb_f1_test, xg_f1_test, lgb_f1_test]
})
...
file_out=open("test_val_scores","wb")
pickle.dump(test_val_scores, file_out)
file_out.close()
...
pickle_in=open('test_val_scores',"rb")
test_val_scores=pickle.load(pickle_in)
...
r.r_test_scores=test_val_scores
...
r_test_scores=r_test_scores %>% 
  rename(precision_test='Precision Test')
...
saveRDS(r_test_scores,"r_test_scores")
...
r_test_scores<-readRDS("r_test_scores")
...
test_prec_plt<-ggplot(r_test_scores, aes(x=reorder(Model, -precision_test), y = precision_test, fill=Model))+ 
  geom_bar(stat = "identity")+
  ggtitle("Test Precision Scores")+
  labs( fill = "Model")+
  scale_y_continuous(labels=scales::percent_format())+
  geom_text(aes(label=precision_test,
        vjust=.09),size=2.5)+
  theme(axis.ticks.x=element_blank(),
        axis.title.y=element_blank(),
        axis.title.x=element_blank(),
...
saveRDS(test_prec_plt,"test_prec_plt")
...
test_prec_plt=readRDS("test_prec_plt")
...
test_precision_plt<-ggplot(r_test_scores, aes(x=reorder(Model, -precision_test), y = precision_test, fill=Model))+ 
    geom_segment( aes(xend=Model, yend=0)) +
...
saveRDS(test_precision_plt,"test_precision_plt")
...
test_precision_plt<-readRDS("test_precision_plt")
...
```{r echo=FALSE,fig.cap="Figure 41"}
...
test_val_scores[['Model', 'Precision Validation', 'Precision Test']]
...
X_cv=model_data.drop("ReportedFraud", axis=1)

y_cv=model_data["ReportedFraud"]
...
y_cv["ReportedFraud"]=label_encoder.fit_transform(y_cv["ReportedFraud"])
...
file_out=open("X_cv","wb")
pickle.dump(X_cv, file_out)
file_out.close()
...
file_out=open("y_cv","wb")
pickle.dump(y_cv, file_out)
file_out.close()
...
X_train_cv, X_test_cv, y_train_cv, y_test_cv=train_test_split(X_cv,y_cv, test_size=0.3,random_state=42, stratify=y_cv)
...
file_out=open("X_train_cv","wb")
pickle.dump(X_train_cv, file_out)
file_out.close()
...
pickle_in=open("X_train_cv","rb")
X_train_cv=pickle.load(pickle_in)
...
file_out=open("X_test_cv","wb")
pickle.dump(X_test_cv, file_out)
file_out.close()
...
pickle_in=open("X_test_cv","rb")
X_test_cv=pickle.load(pickle_in)
...
file_out=open("y_train_cv","wb")
pickle.dump(y_train_cv, file_out)
file_out.close()
...
pickle_in=open("y_train_cv","rb")
y_train_cv=pickle.load(pickle_in)
...
file_out=open("y_test_cv","wb")
pickle.dump(y_test_cv, file_out)
file_out.close()
...
pickle_in=open("y_test_cv","rb")
y_test_cv=pickle.load(pickle_in)
...
y_train_cv_np=np.array(y_train_cv)

y_test_cv_np=np.array(y_test_cv)
...
file_out=open("y_train_cv_np","wb")
pickle.dump(y_train_cv_np, file_out)
file_out.close()
...
pickle_in=open("y_train_cv_np","rb")
y_train_cv_np=pickle.load(pickle_in)
...
file_out=open("y_test_cv_np","wb")
pickle.dump(y_test_cv_np, file_out)
file_out.close()
...
pickle_in=open("y_test_cv_np","rb")
y_test_cv_np=pickle.load(pickle_in)
...
y_train_cv_rv=np.ravel(y_train_cv_np)



y_test_cv_rv=np.ravel(y_test_cv_np)
...
file_out=open("y_train_cv_rv","wb")
pickle.dump(y_train_cv_rv, file_out)
file_out.close()
...
pickle_in=open("y_train_cv_rv","rb")
y_train_cv_rv=pickle.load(pickle_in)
...
file_out=open("y_test_cv_rv","wb")
pickle.dump(y_test_cv_rv, file_out)
file_out.close()
...
pickle_in=open("y_test_cv_rv","rb")
y_test_cv_rv=pickle.load(pickle_in)
...
#Define classification columns
categorical_2 =list(X_train_cv.select_dtypes('category').columns)
print(f"Categorical columns are: {categorical_2}")
...
#Define numeric columns
numerical_2 = list(X_train_cv.select_dtypes('number').columns)
print(f"Numerical columns are: {numerical_2}")
...
ct_tr_2=ColumnTransformer(
  transformers=[
   ('num',StandardScaler(), numerical_2),
   ('cat',OneHotEncoder(handle_unknown='ignore', sparse_output=False,drop='if_binary'), categorical_2)
]
)
...
X_train_cv_tr=ct_tr_2.fit_transform(X_train_cv)
...
file_out=open("X_train_cv_tr","wb")
pickle.dump(X_train_cv_tr, file_out)
file_out.close()
...
pickle_in=open("X_train_cv_tr","rb")
X_train_cv_tr=pickle.load(pickle_in)
...
X_test_cv_tr=ct_tr_2.transform(X_test_cv)
...
file_out=open("X_test_cv_tr","wb")
pickle.dump(X_test_cv_tr, file_out)
file_out.close()
...
pickle_in=open("X_test_cv_tr","rb")
X_test_cv_tr=pickle.load(pickle_in)
...
grid_svc_2=RandomizedSearchCV(svc_ln,param_grid_svc, refit=True, 
verbose=3,cv=5,n_iter=2, scoring='roc_auc',return_train_score=True, n_jobs=-1)
...
grid_svc_2.fit(X_train_cv_tr, y_train_cv_rv)
...
svc_clf_cv=grid_svc_2.best_estimator_
...
file_out=open("svc_clf_cv","wb")
pickle.dump(svc_clf_cv, file_out)
file_out.close()
...
pickle_in=open("svc_clf_cv","rb")
svc_clf_cv=pickle.load(pickle_in)
...
svc_cv_f1_score=cross_val_score(svc_clf_cv, X_train_cv_tr, y_train_cv_rv, 
...
svc_cv_f1_score=svc_cv_f1_score.round(2)
...
file_out=open("svc_cv_f1_score","wb")
pickle.dump(svc_cv_f1_score, file_out)
file_out.close()
...
pickle_in=open("svc_cv_f1_score","rb")
svc_cv_f1_score=pickle.load(pickle_in)
...
svc_cv_recall_score=cross_val_score(svc_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='recall', cv=skf, n_jobs=-1).mean().round(2)
...
svc_cv_recall_score=svc_cv_recall_score.round(2)
...
file_out=open("svc_cv_recall_score","wb")
pickle.dump(svc_cv_recall_score, file_out)
file_out.close()
...
pickle_in=open("svc_cv_recall_score","rb")
svc_cv_recall_score=pickle.load(pickle_in)
...
svc_cv_precision_score=cross_val_score(svc_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='precision', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("svc_cv_precision_score","wb")
pickle.dump(svc_cv_precision_score, file_out)
file_out.close()
...
pickle_in=open("svc_cv_precision_score","rb")
svc_cv_precision_score=pickle.load(pickle_in)
...
adb_cv_grid=RandomizedSearchCV(estimator=adb,
param_distributions=adb_params,n_iter=2, scoring='roc_auc', cv=5, verbose=3, refit=True, n_jobs=-1)
...
adb_cv_grid.fit(X_train_cv_tr, y_train_cv_rv)
...
adb_clf_cv=adb_cv_grid.best_estimator_
...
file_out=open("adb_clf_cv","wb")
pickle.dump(adb_clf_cv, file_out)
file_out.close()
...
pickle_in=open("adb_clf_cv","rb")
adb_clf_cv=pickle.load(pickle_in)
...
adb_cv_f1_score=cross_val_score(adb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='f1', cv=skf, n_jobs=-1).mean()
...
adb_cv_recall_score=cross_val_score(adb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='recall', cv=skf, n_jobs=-1).mean().round(2)
...
adb_cv_recall_score=adb_cv_recall_score.round(2)
...
file_out=open("adb_cv_recall_score","wb")
pickle.dump(adb_cv_recall_score, file_out)
file_out.close()
...
pickle_in=open("adb_cv_recall_score","rb")
adb_cv_recall_score=pickle.load(pickle_in)
...
adb_cv_precision_score=cross_val_score(adb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='precision', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("adb_cv_precision_score","wb")
pickle.dump(adb_cv_precision_score, file_out)
file_out.close()
...
pickle_in=open("adb_cv_precision_score","rb")
adb_cv_precision_score=pickle.load(pickle_in)
...
search_cv_rf=RandomizedSearchCV(rf, rf_params, n_iter=2,refit=True, verbose=3,cv=5, scoring='roc_auc',return_train_score=True, n_jobs=-1)
...
search_cv_rf.fit(X_train_cv_tr, y_train_cv_rv)
...
rf_clf_cv=search_cv_rf.best_estimator_
...
file_out=open("rf_clf_cv","wb")
pickle.dump(rf_clf_cv, file_out)
file_out.close()
...
pickle_in=open("rf_clf_cv","rb")
rf_clf_cv=pickle.load(pickle_in)
...
rf_cv_f1_score=cross_val_score(rf_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='f1', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("rf_cv_f1_score","wb")
pickle.dump(rf_cv_f1_score, file_out)
file_out.close()
...
pickle_in=open("rf_cv_f1_score","rb")
rf_cv_f1_score=pickle.load(pickle_in)
...
rf_cv_recall_score=cross_val_score(rf_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='recall', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("rf_cv_recall_score","wb")
pickle.dump(rf_cv_recall_score, file_out)
file_out.close()
...
pickle_in=open("rf_cv_recall_score","rb")
rf_cv_recall_score=pickle.load(pickle_in)
...
rf_cv_precision_score=cross_val_score(rf_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='precision', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("rf_cv_precision_score","wb")
pickle.dump(rf_cv_precision_score, file_out)
file_out.close()
...
pickle_in=open("rf_cv_precision_score","rb")
rf_cv_precision_score=pickle.load(pickle_in)
...
search_cv_adb=RandomizedSearchCV(estimator=adb,
param_distributions=adb_params,n_iter=2, scoring='roc_auc', cv=5, verbose=3, refit=True, n_jobs=-1)
...
search_cv_adb.fit(X_train_cv_tr, y_train_cv_rv)
...
adb_clf_cv=search_cv_adb.best_estimator_
...
file_out=open("adb_cv_f1_score","wb")
pickle.dump(adb_cv_f1_score, file_out)
file_out.close()
...
pickle_in=open("adb_cv_f1_score","rb")
adb_cv_f1_score=pickle.load(pickle_in)
...
search_cv_gb=RandomizedSearchCV(estimator=gb,
param_distributions=gb_params,n_iter=2, scoring='roc_auc', cv=5, verbose=1, refit=True, n_jobs=-1, random_state=2)
...
search_cv_gb.fit(X_train_cv_tr, y_train_cv_rv)
...
gb_clf_cv=search_cv_gb.best_estimator_
...
file_out=open("gb_clf_cv","wb")
pickle.dump(gb_clf_cv, file_out)
file_out.close()
...
pickle_in=open("gb_clf_cv","rb")
gb_clf_cv=pickle.load(pickle_in)
...
gb_cv_f1_score=cross_val_score(gb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='f1', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("gb_cv_f1_score","wb")
pickle.dump(gb_cv_f1_score, file_out)
file_out.close()
...
pickle_in=open("gb_cv_f1_score","rb")
gb_cv_f1_score=pickle.load(pickle_in)
...
gb_cv_recall_score=cross_val_score(gb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='recall', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("gb_cv_recall_score","wb")
pickle.dump(gb_cv_recall_score, file_out)
file_out.close()
...
pickle_in=open("gb_cv_recall_score","rb")
gb_cv_recall_score=pickle.load(pickle_in)
...
gb_cv_precision_score=cross_val_score(gb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='precision', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("gb_cv_precision_score","wb")
pickle.dump(gb_cv_precision_score, file_out)
file_out.close()
...
pickle_in=open("gb_cv_precision_score","rb")
gb_cv_precision_score=pickle.load(pickle_in)
...
search_cv_xg=RandomizedSearchCV(estimator=estimator_xg,
param_distributions=params_xg,n_iter=2, scoring='roc_auc', cv=5, verbose=3, refit=True, n_jobs=-1)
...
search_cv_xg.fit(X_train_cv_tr, y_train_cv_rv)
...
xg_clf_cv=search_cv_xg.best_estimator_
...
file_out=open("xg_clf_cv","wb")
pickle.dump(xg_clf_cv, file_out)
file_out.close()
...
pickle_in=open("xg_clf_cv","rb")
xg_clf_cv=pickle.load(pickle_in)
...
xg_cv_f1_score=cross_val_score(xg_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='f1', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("xg_cv_f1_score","wb")
pickle.dump(xg_cv_f1_score,file_out)
file_out.close()
...
pickle_in=open("xg_cv_f1_score","rb")
xg_cv_f1_score=pickle.load(pickle_in)
...
xg_cv_recall_score=cross_val_score(xg_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='recall', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("xg_cv_recall_score","wb")
pickle.dump(xg_cv_recall_score, file_out)
file_out.close()
...
pickle_in=open("xg_cv_recall_score","rb")
xg_cv_recall_score=pickle.load(pickle_in)
...
xg_cv_precision_score=cross_val_score(xg_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='precision', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("xg_cv_precision_score","wb")
pickle.dump(xg_cv_precision_score, file_out)
file_out.close()
...
pickle_in=open("xg_cv_precision_score","rb")
xg_cv_precision_score=pickle.load(pickle_in)
...
lgb_search_2 = RandomizedSearchCV(
    estimator=lgb_model, param_distributions=params_lgb, 
    n_iter=n_HP_points_to_test,
    scoring='roc_auc',
    cv=5,
...
lgb_search_2.fit(X_train_cv_tr, y_train_cv_rv)
...
lgb_clf_cv=lgb_search_2.best_estimator_
...
file_out=open("lgb_clf_cv","wb")
pickle.dump(lgb_clf_cv, file_out)
file_out.close()
...
pickle_in=open("lgb_clf_cv","rb")
lgb_clf_cv=pickle.load(pickle_in)
...
lgb_cv_f1_score=cross_val_score(lgb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='f1', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("lgb_cv_f1_score","wb")
pickle.dump(lgb_cv_f1_score, file_out)
file_out.close()
...
pickle_in=open("lgb_cv_f1_score","rb")
lgb_cv_f1_score=pickle.load(pickle_in)
...
lgb_cv_recall_score=cross_val_score(lgb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='recall', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("lgb_cv_recall_score","wb")
pickle.dump(lgb_cv_recall_score, file_out)
file_out.close()
...
pickle_in=open("lgb_cv_recall_score","rb")
lgb_cv_recall_score=pickle.load(pickle_in)
...
lgb_cv_precision_score=cross_val_score(lgb_clf_cv, X_train_cv_tr, y_train_cv_rv, 
scoring='precision', cv=skf, n_jobs=-1).mean().round(2)
...
file_out=open("lgb_cv_precision_score","wb")
pickle.dump(lgb_cv_precision_score, file_out)
file_out.close()
...
pickle_in=open("lgb_cv_precision_score","rb")
lgb_cv_precision_score=pickle.load(pickle_in)
...
cross_val_scores=pd.DataFrame({'Model':['Support Vector Machine',  'Random Forest', 'Ada Boost','Gradient Boost',  'Light GBM'],
'Recall':[svc_cv_recall_score, rf_cv_recall_score, adb_cv_recall_score,lgb_cv_recall_score,gb_cv_recall_score],
'Precision':[svc_cv_precision_score, rf_cv_precision_score, adb_cv_precision_score, gb_cv_precision_score,lgb_cv_precision_score],
'F1':[svc_cv_f1_score, rf_cv_f1_score, adb_cv_f1_score,gb_cv_f1_score, lgb_cv_f1_score]
})
...
file_out=open("cross_val_scores","wb")
pickle.dump(cross_val_scores, file_out)
file_out.close()
...
pickle_in=open("cross_val_scores","rb")
cross_val_scores=pickle.load(pickle_in)
...
r.r_cross_val_scores=cross_val_scores
...
saveRDS(r_cross_val_scores,"r_cross_val_scores")
...
r_cross_val_scores<-readRDS("r_cross_val_scores")
...
crossVal_prec_plt<-ggplot(r_cross_val_scores, aes(x=reorder(Model, -Precision), y = Precision, fill=Model))+ 
  geom_bar(stat = "identity")+
  ggtitle("Test Precision Scores")+
  labs( fill = "Model")+
  scale_y_continuous(labels=scales::percent_format())+
  geom_text(aes(label=Precision,
        vjust=.09),size=2.5, color="black")+
  theme(axis.ticks.x=element_blank(),
        axis.title.y=element_blank(),
        axis.title.x=element_blank(),
        axis.text.x=element_text(angle=70, size=8,hjust=1),
        ...
        axis.ticks = element_blank(),
        legend.position = "none",
        plot.title=element_text(color="purple",face="bold.italic",size=10, hjust=0.5))+
  expand_limits(y = c(0, 0.99))
...
crossval_plt<-ggplot(r_cross_val_scores, aes(x = reorder( Model,-Precision), y=Precision,color=Model)) +
    geom_segment( aes(xend=Model, yend=0)) +
...
```{r echo=FALSE,fig.cap="Figure 42"}
...
svc_clf_cv.fit(X_train_cv_tr, y_train_cv_rv)
...
y_pred_svc_test=svc_clf_cv.predict(X_test_cv_tr)
...
file_out=open("y_pred_svc_test","wb")
pickle.dump(y_pred_svc_test, file_out)
file_out.close()
...
pickle_in=open("y_pred_svc_test","rb")
y_pred_svc_test=pickle.load(pickle_in)
...
print('******SVC Final Test Set Classification Report******')

print(classification_report(y_test_cv_rv, y_pred_svc_test))
...
svc_cv_test_prec=precision_score(y_test_cv_rv, y_pred_svc_test).round(2)
...
file_out=open("svc_cv_test_prec","wb")
pickle.dump(svc_cv_test_prec, file_out)
file_out.close()
...
pickle_in=open("svc_cv_test_prec","rb")
svc_cv_test_prec=pickle.load(pickle_in)
...
rf_clf_cv.fit(X_train_cv_tr, y_train_cv_rv)
...
y_pred_rf_test=rf_clf_cv.predict(X_test_cv_tr)
...
file_out=open("y_pred_rf_test","wb")
pickle.dump(y_pred_rf_test, file_out)
file_out.close()
...
pickle_in=open("y_pred_rf_test","rb")
y_pred_rf_test=pickle.load(pickle_in)
...
print("*******Random Forest Final Test Set Classification Report********")

print(classification_report(y_test_cv_rv, y_pred_rf_test))
...
rf_cv_test_prec=precision_score(y_test_cv_rv, y_pred_rf_test).round(2)
...
file_out=open("rf_cv_test_prec","wb")
pickle.dump(rf_cv_test_prec, file_out)
file_out.close()
...
pickle_in=open("rf_cv_test_prec","rb")
rf_cv_test_prec=pickle.load(pickle_in)
...
adb_clf_cv.fit(X_train_cv_tr, y_train_cv_rv)
...
y_pred_adb_test=adb_clf_cv.predict(X_test_cv_tr)
...
file_out=open("y_pred_adb_test","wb")
pickle.dump(y_pred_adb_test, file_out)
file_out.close()
...
pickle_in=open("y_pred_adb_test","rb")
y_pred_adb_test=pickle.load(pickle_in)
...
print("*******AdaBoost Final Test Set Classification Report********")

print(classification_report(y_test_cv_rv, y_pred_adb_test))
...
adb_cv_test_prec=precision_score(y_test_cv_rv, y_pred_adb_test).round(2)
...
file_out=open("adb_cv_test_prec","wb")
pickle.dump(adb_cv_test_prec, file_out)
file_out.close()
...
pickle_in=open("adb_cv_test_prec","rb")
adb_cv_test_prec=pickle.load(pickle_in)
...
gb_clf_cv.fit(X_train_cv_tr, y_train_cv_rv)
...
y_pred_gb_test=gb_clf_cv.predict(X_test_cv_tr)
...
file_out=open("y_pred_gb_test","wb")
pickle.dump(y_pred_gb_test, file_out)
file_out.close()
...
pickle_in=open("y_pred_gb_test","rb")
y_pred_gb_test=pickle.load(pickle_in)
...
print("*******Gradient Boost Final Test Set Classification Report********")

print(classification_report(y_test_cv_rv, y_pred_gb_test))
...
gb_cv_test_prec=precision_score(y_test_cv_rv, y_pred_gb_test).round(2)
...
file_out=open("gb_cv_test_prec","wb")
pickle.dump(gb_cv_test_prec, file_out)
file_out.close()
...
pickle_in=open("gb_cv_test_prec","rb")
gb_cv_test_prec=pickle.load(pickle_in)
...
lgb_clf_cv.fit(X_train_cv_tr, y_train_cv_rv)
...
y_pred_lgb_test=lgb_clf_cv.predict(X_test_cv_tr)
...
file_out=open("y_pred_lgb_test","wb")
pickle.dump(y_pred_lgb_test, file_out)
file_out.close()
...
pickle_in=open("y_pred_lgb_test","rb")
y_pred_lgb_test=pickle.load(pickle_in)
...
print("*****Light Gradient Boost Final Test Set Classification Report******")

print(classification_report(y_test_cv_rv, y_pred_lgb_test))
...
lgb_cv_test_prec=precision_score(y_test_cv_rv, y_pred_lgb_test).round(2)
...
file_out=open("lgb_cv_test_prec","wb")
pickle.dump(lgb_cv_test_prec, file_out)
file_out.close()
...
pickle_in=open("lgb_cv_test_prec","rb")
lgb_cv_test_prec=pickle.load(pickle_in)
...
final_test_scores=pd.DataFrame({'Model':['Support Vector Machine',  'Random Forest', 'Ada Boost','Gradient Boost',  'Light GBM'],'Precision':[svc_cv_test_prec, rf_cv_test_prec, adb_cv_test_prec,gb_cv_test_prec, lgb_cv_test_prec],
...
file_out=open("final_test_scores","wb")
pickle.dump(final_test_scores, file_out)
file_out.close()
...
pickle_in=open("final_test_scores","rb")
final_test_scores=pickle.load(pickle_in)
...
r.r_final_test_scores=final_test_scores
...
saveRDS(r_final_test_scores,"r_final_test_scores")
...
r_final_test_scores<-readRDS("r_final_test_scores")
...
finl_prec_plt<-ggplot(r_final_test_scores, aes(x=reorder(Model, -Precision), y = Precision, fill=Model))+ 
  geom_bar(stat = "identity")+
  ggtitle("Final Test Precision Scores")+
  labs( fill = "Model")+
  scale_y_continuous(labels=scales::percent_format())+
  geom_text(aes(label=Precision,
        vjust=.09),size=5, color="black")+
  theme(axis.ticks.x=element_blank(),
        axis.title.y=element_blank(),
        axis.title.x=element_blank(),
        axis.text.x=element_text(angle=70, size=8,hjust=1),
...
```{r echo=FALSE,fig.cap="Figure 43"}
...
feat_dict_final_rf= {}
for col, val in sorted(zip(X_train_cv_tr.columns, rf_clf_cv.feature_importances_),key=lambda x:x[1],reverse=True):
  feat_dict_final_rf[col]=val
...
feat_final_rf_df = pd.DataFrame({'Feature':feat_dict_final_rf.keys(),'Importance':feat_dict_final_rf.values()})
...
feat_final_rf_tp5=feat_final_rf_df.nlargest(5,"Importance")
...
file_out=open("feat_final_rf_tp5","wb")
pickle.dump(feat_final_rf_tp5, file_out)
file_out.close()
...
pickle_in=open("feat_final_rf_tp5","rb")
feat_final_rf_tp5=pickle.load(pickle_in)
...
values = feat_final_rf_tp5.Importance    
idx = feat_final_rf_tp5.Feature
plt.figure(figsize=(15,10))
clrs = ['green' if (x < max(values)) else 'red' for x in values ]
sns.barplot(y=idx,x=values,palette=clrs).set(title='Important Features Final Random Forest Model')
...
```{python echo=FALSE,fig.cap="Figure 44"}
...
feat_dict_final_adb= {}
for col, val in sorted(zip(X_train_cv_tr.columns, adb_clf_cv.feature_importances_),key=lambda x:x[1],reverse=True):
  feat_dict_final_adb[col]=val
...
feat_final_adb_df = pd.DataFrame({'Feature':feat_dict_final_adb.keys(),'Importance':feat_dict_final_adb.values()})
...
feat_final_adb_tp5=feat_final_adb_df.nlargest(5,"Importance")
...
file_out=open("feat_final_adb_tp5","wb")
pickle.dump(feat_final_adb_tp5, file_out)
file_out.close()
...
pickle_in=open("feat_final_adb_tp5","rb")
feat_final_adb_tp5=pickle.load(pickle_in)
...
values = feat_final_adb_tp5.Importance    
idx = feat_final_adb_tp5.Feature
plt.figure(figsize=(15,10))
clrs = ['green' if (x < max(values)) else 'red' for x in values ]
sns.barplot(y=idx,x=values,palette=clrs).set(title='Important Features Final AdaBoost Model')
...
```{python echo=FALSE,fig.cap="Figure 45"}
...
feat_dict_final_gb= {}
for col, val in sorted(zip(X_train_cv_tr.columns, gb_clf_cv.feature_importances_),key=lambda x:x[1],reverse=True):
  feat_dict_final_gb[col]=val
...
feat_final_gb_df = pd.DataFrame({'Feature':feat_dict_final_gb.keys(),'Importance':feat_dict_final_gb.values()})
...
feat_final_gb_tp5=feat_final_gb_df.nlargest(5,"Importance")
...
file_out=open("feat_final_gb_tp5","wb")
pickle.dump(feat_final_gb_tp5, file_out)
file_out.close()
...
pickle_in=open("feat_final_gb_tp5","rb")
feat_final_gb_tp5=pickle.load(pickle_in)
...
values = feat_final_gb_tp5.Importance    
idx = feat_final_gb_tp5.Feature
plt.figure(figsize=(15,10))
clrs = ['green' if (x < max(values)) else 'red' for x in values ]
sns.barplot(y=idx,x=values,palette=clrs).set(title='Important Features Final Random Forest Model')
...
```{python echo=FALSE,fig.cap="Figure 46"}
...
feat_dict_final_lgb= {}
for col, val in sorted(zip(X_train_cv_tr.columns, lgb_clf_cv.feature_importances_),key=lambda x:x[1],reverse=True):
  feat_dict_final_lgb[col]=val
...
feat_final_lgb_df = pd.DataFrame({'Feature':feat_dict_final_lgb.keys(),'Importance':feat_dict_final_lgb.values()})
...
feat_final_lgb_tp5=feat_final_lgb_df.nlargest(5,"Importance")
...
file_out=open("feat_final_lgb_tp5","wb")
pickle.dump(feat_final_lgb_tp5, file_out)
file_out.close()
...
pickle_in=open("feat_final_lgb_tp5","rb")
feat_final_lgb_tp5=pickle.load(pickle_in)
...
values = feat_final_lgb_tp5.Importance    
idx = feat_final_lgb_tp5.Feature
plt.figure(figsize=(15,10))
clrs = ['green' if (x < max(values)) else 'red' for x in values ]
sns.barplot(y=idx,x=values,palette=clrs).set(title='Important Features Final Light Gradient Boost Model')
...
```{python echo=FALSE,fig.cap="Figure 47"}
